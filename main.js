...
// Still not working. Can't get the squeal to work.
...
function Safe(content, open) {
    var safeContent = []
    safeContent.push(content)
    var safeKey = []
    safeKey.push(open)

    Safe.prototype.unlock = function(open) {
        console.log("open is", open)
        console.log("safeKey is", safeKey)
        if (open.toString() === safeKey.toString()) {
            return safeContent
        }
    }
}
...
// When I test this ↑ with my code below, it works.
// When I run the "Validating" code block below it,
// it gives an Assertion failed error.

var myValid = new Validator()
myValid.email("adamjahr@gmail.com") > returns "true"
myValid.email("adamjahrgmail.com") > returns "false"
